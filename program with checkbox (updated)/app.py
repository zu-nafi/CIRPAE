...
os.environ["OPENAI_API_KEY"] = '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'
...
predetermined_word_sets = {
    ...
    "Network": ["connection", "firewall", "monitoring", "network", "active directory", "firewall rules"],
    "Security / Data protection": ["Antivirus", "encryption", "access control", "data breach", "data privacy", "intrusion detection"],
    "Authentication and Authorization": ["authentication", "authorization", "access control", "biometrics", "ACL (Access Control List)"],
    "Malware": ["virus", "trojan", "worm", "ransomware", "spyware", "malicious code"],
    "Phishing": ["phishing", "spear phishing", "phishing email", "phishing website", "social engineering"],
    "Cloud Security": ["Cloud Computing", "AWS Security", "Azure Security", "Google Cloud Security", "SaaS Security", "IaaS Security"],
    "Network Security Protocols": ["TLS/SSL", "IPsec", "SSH", "VPN", "WPA3", "DNSSEC"]
